import { f as createLucideIcon, r as reactExports, j as jsxRuntimeExports, a as LoadingSpinner, C as ClipboardList, B as Button, X } from "./index-DQCkNZNn.js";
import { C as CityAutocomplete } from "./CityAutocomplete-DwozbWMr.js";
import { E as ErrorMessage } from "./ErrorMessage-BRHU4X-a.js";
import { S as StatusBadge } from "./StatusBadge-DsslqyLb.js";
import { e as useAllBookings, c as useUpdateBookingStatus, a as useCreateBooking } from "./useBookings-DwCb6qr3.js";
import { u as useVendors } from "./useVendors-C4cOzju-.js";
import { u as ue } from "./index-CMlHxj7m.js";
import { P as Plus } from "./plus-C8U_Ib_U.js";
import { M as MapPin } from "./map-pin-BO5uW0KS.js";
...
function CreateBookingModal({ onClose }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!selectedVendor) {
      ue.error("Please select a vendor");
      return;
    }
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card w-full sm:max-w-lg rounded-t-2xl sm:rounded-xl border border-border shadow-elevated overflow-y-auto max-h-[90vh]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "p-4 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", htmlFor: "admin-booking-vendor", children: "Vendor *" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: createBooking.isPending ? "Creating..." : "Create Booking"
            }
          )
        ] })
      ] })
