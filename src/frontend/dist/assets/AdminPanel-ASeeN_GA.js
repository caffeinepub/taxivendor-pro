import { f as createLucideIcon, h as useActor, i as useQuery, n as createActor, j as jsxRuntimeExports, D as Users, e as BookOpen, F as Star, s as ClipboardList, C as Car, L as Link, T as ThemeSwitcher } from "./index-Dg4inA2B.js";
import { R as RefreshCw } from "./refresh-cw-Vu6KezLY.js";
import { C as CircleCheck } from "./circle-check-BKM_uBlX.js";
import { C as Clock } from "./clock-B6vbK9JW.js";
import { T as TrendingUp } from "./trending-up-4T7wvlWA.js";
/**
...
function AdminPanel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-6 space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-card space-y-3", "data-ocid": "admin-theme-section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-base font-semibold text-foreground", children: "App Theme" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Choose a color theme for the entire app." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeSwitcher, { showLabel: true })
    ] })
  ] });
}
export {
