import { f as createLucideIcon, p as useParams, u as useVendorAuth, b as useNavigate, r as reactExports, j as jsxRuntimeExports, a as LoadingSpinner, B as Button, C as Car } from "./index-Dg4inA2B.js";
import { u as ue } from "./index-rrB9sIEM.js";
import { C as ClickableContact } from "./ClickableContact-B0F0GtZY.js";
import { D as DocumentUpload } from "./DocumentUpload-DGcvaRBO.js";
import { E as ErrorMessage } from "./ErrorMessage-XYba8C8j.js";
import { S as StatusBadge } from "./StatusBadge-B0YaaiuA.js";
import { b as useBooking, c as useUpdateBookingStatus, d as useUpdateDriverDetails } from "./useBookings-CGrFJ29G.js";
...
import "./circle-check-big-DRwabk1o.js";
import "./circle-x-YXb0KY8s.js";
...
function BookingDetail() {
  ...
  const handleSaveDriver = async () => {
    ...
    try {
      ...
      const isVoidDecodeError = msg.toLowerCase().includes("v3") || msg.toLowerCase().includes("expected") || msg.toLowerCase().includes("response body") || msg.toLowerCase().includes("candid") || msg.toLowerCase().includes("decode");
