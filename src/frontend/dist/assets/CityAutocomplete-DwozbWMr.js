import { f as createLucideIcon, g as useActor, r as reactExports, m as createActor, j as jsxRuntimeExports, n as cn } from "./index-DQCkNZNn.js";
...
function CityAutocomplete({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: containerRef, className: "relative", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-primary flex-shrink-0 pointer-events-none z-10" }),
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute z-[9999] top-full left-0 right-0 mt-1 bg-card border border-border rounded-md shadow-elevated overflow-hidden max-h-60 overflow-y-auto", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 text-sm text-muted-foreground flex items-center gap-2", children: [
      ...
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-foreground leading-tight", children: city.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground mt-0.5", children: city.state })
        ]
      },
      city.id
    )) })
