import { d as createLucideIcon, j as jsxRuntimeExports, C as Car, L as Link, B as Button } from "./index-CxP7RHi8.js";
import { C as CircleCheckBig } from "./circle-check-big-DohWIESh.js";
import { M as MapPin } from "./map-pin-BNPsUAqv.js";
import { S as Shield } from "./shield-BZ-bvQk0.js";
/**
...
function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "flex-1 flex flex-col items-center justify-center px-5 py-16 text-center bg-gradient-to-b from-card to-background", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-2xl bg-primary flex items-center justify-center shadow-lg mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Car, { className: "w-10 h-10 text-primary-foreground" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-bold text-4xl sm:text-5xl text-foreground leading-tight tracking-tight mb-4", children: [
        "Manage your taxi bookings",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "with ease" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground max-w-sm mb-8 leading-relaxed", children: "KabGo helps cab vendors post trips, track earnings, and manage driver assignments — all from your phone." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-muted/30 border-t border-border px-5 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl text-foreground text-center mb-8", children: "Everything you need to run your fleet" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-background border-t border-border px-5 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl text-foreground text-center mb-8", children: "How it works" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-primary px-5 py-10 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl text-primary-foreground mb-2", children: "Ready to grow your cab business?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-primary-foreground/80 mb-6", children: "Join hundreds of vendors managing bookings on KabGo" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/signup", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: "Create Vendor Account"
        }
      ) })
    ] })
  ] });
