import { u as useVendorAuth, r as reactExports, j as jsxRuntimeExports, L as Link, B as Button, a as LoadingSpinner } from "./index-DQCkNZNn.js";
import { D as DocumentUpload } from "./DocumentUpload-DEhxSkTx.js";
import { E as ErrorMessage } from "./ErrorMessage-BRHU4X-a.js";
import { C as CircleCheckBig } from "./circle-check-big-Cx5NdOwy.js";
import { C as Car } from "./car-MBMO8q4G.js";
import { E as EyeOff, a as Eye } from "./eye-oB_oejFw.js";
import "./file-text-BtZRe5l8.js";
import "./circle-x-CJibahge.js";
import "./refresh-cw-Db75svbM.js";
const INITIAL = {
  name: "",
  mobile: "",
  companyName: "",
...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      result = {
        success: false,
        error: "Registration failed. Please try again. / Registration fail ho gayi. Dobara try karein."
      };
    }
    if (result.success) {
      setSuccess(true);
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-2xl text-foreground mb-2", children: "Application Submitted!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm max-w-xs leading-relaxed mb-8", children: "Your vendor application is under review. You'll be able to log in once an admin approves your account." }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-8 max-w-md mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1 text-center", children: "Join KabGo — submit your details for admin approval" })
    ] }),
